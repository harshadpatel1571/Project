                    ...
                    <div class="single-blog-post featured-post-2">
                        <div class="row">
                            ...
                            <div class="col-4" style="text-align: right;">
                                <a href="whatsapp://send?text=http://localhost:50444/news.aspx?id={{SingleNews.nm_id}}" data-action="share/whatsapp/share" id="div_mobile" target="_blank">
                                    <label class="fa fa-whatsapp bg-danger btn rounded text-white">M</label>
                                </a>
                                <a href="https://web.whatsapp.com/send?text=http://localhost:50444/News.aspx?id={{SingleNews.nm_id}}" data-action="share/whatsapp/share" id="div_desctop" target="_blank">
